...
<style>
  ...
  <nav class="nav-switch" aria-label="网关导航">
    <a href="/home" title="LLM Gateway 总览首页"><span class="icon">🚀</span>总览</a>
    <a href="/quota" title="JetBrains Enterprise AI 配额面板"><span class="icon">🧠</span>JBA</a>
    <a href="/ghe/quota" class="active" title="GitHub Enterprise Copilot 配额面板"><span class="icon">🐙</span>GHE</a>
    <a href="/billing-dashboard" title="所有上游统一计费 dashboard · 按 API Key / 模型 / 账号"><span class="icon">💰</span>计费</a>
    <a href="/traffic-dashboard" title="流量明细 · 每条请求 req/resp body · 全文搜索"><span class="icon">📊</span>流量</a>
    <a href="/usage-keeper/" title="CLIProxyAPI 原生 usage dashboard · token 维度"><span class="icon">📈</span>Usage</a>
    <a href="/management.html" title="CPAMC 管理面板 · OAuth / 配额 / Key / 提供商"><span class="icon">⚙️</span>管理</a>
  </nav>
